    ...
    return (
        <div className='weOffer-page'>
            ...
            <Grid
                ...
                container spacing={4} sx={{ width: '90%', mx: 'auto', padding: 3 }}>
                <Grid item lg={12} md={12} sm={12} xs={12}>
                    <Grid container spacing={1}>
                        <Grid
                            ...
                            <Typography
                                variant='h2' sx={{ fontWeight: 'bold', color: '#FF497C' }}>Strategy</Typography>
                        </Grid>
                        <Grid item xs={12} sm={12} md={4} lg={4} sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                            <img style={{ width: '280px', height: '280px', borderRadius: '50%', border: '8px solid #000108', padding: '5px' }} src='https://i.ibb.co/85pRrwQ/strategy.jpg' alt="" />
                        </Grid>
                        <Grid
                            data-aos="fade-left"
                            data-aos-duration="3000"
                ...
                <Grid item lg={12} md={12} sm={12} xs={12}>
                    <Grid container spacing={1}>
                        ...
                        <Grid item xs={12} sm={12} md={4} lg={4} sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                            <img style={{ width: '280px', height: '280px', borderRadius: '50%', border: '8px solid #000108', padding: '5px' }} src="https://i.ibb.co/3zjYDw8/develop.jpg" alt="" />
                        </Grid>
                        <Grid
                            data-aos="fade-left"
                            data-aos-duration="3000"
                ...
                <Grid item lg={12} md={12} sm={12} xs={12}>
                    <Grid container spacing={1}>
                        ...
                        <Grid item xs={12} sm={12} md={4} lg={4} sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                            <img style={{ width: '280px', height: '280px', borderRadius: '50%', border: '8px solid #000108', padding: '5px' }} src="https://i.ibb.co/2FmKT62/support.jpg" alt="" />
                        </Grid>
                        <Grid
                            data-aos="fade-left"
                            data-aos-duration="3000"
